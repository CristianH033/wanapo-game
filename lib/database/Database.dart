    ...
    return await openDatabase(
      ...
      onCreate: (Database db, int version) async {
        ...
        await db.execute(
            ...
            "(id, texto, puntaje)"
            "VALUES (1,'What are the countries in which Grupo Energía Bogotá operates in?',1),"
            "(2,'In what country are we #1 in the gas and electric energy market?',1),"
            "(3,'In what country are we #1 in the gas-transport market?',1),"
            "(4,'What is the capacity of TGI in Colombia?',1),"
            "(5,'What is TGI’s market share in Colombia?',1),"
            "(6,'What is the amount (in kilometers) of infrastructure that TGI currently has in Colombia?',1),"
            "(7,'What are the companies that Grupo Energía Bogotá currently has in the Peruvian Gas Market?',1),"
            "(8,'What is the capacity of Cálidda in Peru?',1),"
            "(9,'How many districts does Calidda operate in between the cities of Lima and Callao?',1),"
            "(10,'What is the capacity of Contugas in Peru?',1),"
            "(11,'What is the amount (in kilometers) of infrastructure that Contugas currently has in Peru?',1)"
        );
        ...
        await db.execute(
            ...
            "(3,'Guatemala, Brazil, Peru and Colombia',1,1),"
            "(4,'USA, Mexico, Colombia and Peru',0,1),"
            "(5,'Colombia',0,2),"
            "(6,'Peru',1,2),"
            "(7,'Guatemala',0,2),"
            "(8,'Brazil',0,2),"
